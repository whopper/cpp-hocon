...
namespace hocon {
    ...
    class token {
    public:
        token(token_type type, std::unique_ptr<simple_config_origin> origin = nullptr,
        ...
        virtual simple_config_origin origin() const;
    ...
    private:
        ...
        std::unique_ptr<simple_config_origin> _origin;
