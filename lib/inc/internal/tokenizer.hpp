...
namespace hocon {
    ...
    private:
        ...
        private:
            std::shared_ptr<token> next_is_not_simple_value(simple_config_origin base_origin, int line_number);
            std::shared_ptr<token> next_is_simple_value(simple_config_origin origin, int line_number);
            std::shared_ptr<token> create_whitespace_token(simple_config_origin base_origin, int line_number);
        ...
        static std::shared_ptr<simple_config_origin> line_origin(simple_config_origin base_origin,
                                                                 int line_number);
